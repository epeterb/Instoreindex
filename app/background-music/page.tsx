...
export const metadata: Metadata = {
  ...
  description:
    "Independent research on commercial background music providers for multi-location businesses. Full profiles of 11 providers, head-to-head comparisons, and vendor-neutral pricing research.",
  alternates: {
...
const collectionLd = {
  ...
  description:
    "Independent research on commercial background music providers for multi-location businesses.",
};
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
        ...
        <header className="mb-12">
          ...
          <p className="text-xl text-gray-100 leading-relaxed max-w-3xl">
            Independent profiles of 11 commercial music providers,
            head-to-head comparisons, and original pricing research for
            multi-location businesses. No vendor relationships. No
            affiliate links.
          </p>
        </header>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">
            The pricing research is the fastest way to calibrate what you
            should expect to pay before you start taking vendor meetings.
          </p>

          
            href="/research/background-music-pricing/"
            className="block p-5 bg-navy-900 border border-navy-800 rounded-lg hover:border-accent no-underline group max-w-2xl"
          >
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">
            Independent analysis of every provider we track. Company
