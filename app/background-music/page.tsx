...
export const metadata: Metadata = {
  title: "Background Music for Business: Provider Analysis and Pricing Research | InStoreIndex",
  description: "Independent research on commercial background music providers for multi-location businesses. Full profiles of 11 providers, head-to-head comparisons, and vendor-neutral pricing research.",
  alternates: {
    canonical: "https://instoreindex.com/background-music/",
  },
};
...
const collectionLd = {
  ...
  description: "Independent research on commercial background music providers for multi-location businesses.",
};
  ...
  return (
    <main className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
      ...
      <header className="mb-12">
        <p className="text-sm font-medium text-gray-400 uppercase tracking-widest mb-2">Independent Research</p>
        <h1 className="text-4xl mb-4">Background Music for Business</h1>
        <p className="text-xl text-gray-100 leading-relaxed max-w-3xl">
          Independent profiles of 11 commercial music providers, head-to-head comparisons, and original pricing research for multi-location businesses. No vendor relationships. No affiliate links.
        </p>
      </header>

      <section className="mb-16">
        <h2 className="text-2xl font-semibold text-white mb-2">Start here</h2>
        <p className="text-gray-400 mb-6">The pricing research is the fastest way to calibrate what you should expect to pay before you start taking vendor meetings.</p>
        ...
        <a href="/research/background-music-pricing/" className="block p-5 bg-navy-900 border border-navy-800 rounded-lg hover:border-accent no-underline group max-w-2xl">
          ...
          <p className="text-xs text-accent mt-3">Read the research &rarr;</p>
        </a>
      </section>

      <section className="mb-16">
        <h2 className="text-2xl font-semibold text-white mb-2">Provider profiles</h2>
        <p className="text-gray-400 mb-6">Independent analysis of every provider we track. Company background, pricing research, strengths, weaknesses, and verdict.</p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <a href="/analysis/activaire/" className="block p-5 bg-navy-900 border border-navy-800 rounded-lg hover:border-accent no-underline group">
            ...
            <p className="text-xs text-accent mt-3">Full profile &rarr;</p>
          </a>
      ...
      <section className="mb-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <a href="/analysis/mti-vs-mood-media/" className="block p-5 bg-navy-900 border border-navy-800 rounded-lg hover:border-accent no-underline group">
            ...
            <p className="text-xs text-accent mt-3">Read comparison &rarr;</p>
          </a>
